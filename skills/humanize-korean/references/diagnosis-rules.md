...
> 처방·학술 인용·버전주석은 SSOT 참조. **82패턴 전수** 수록
...
- **K-1** [S1] 수사적 설정 — 질문 던지고 자답 · fork 신규 — 독자에게 질문을 던진 뒤 필자가 곧바로 답하는 구조. 강연 대본의…
  시그니처: 질문형 종결 직후 같은 화자가 답하는 문장(보이시나요/할까요/왜 중요하냐면) · 예: "공통점이 보이시나요?" / "왜 중요하냐면요,"…
- **K-2** [S2] 담화 메타 조인트 · fork 신규 — 글의 구조를 독자에게 안내하는 표지. 독자는 지금 읽고 있는 중이라…
  시그니처: 담화 표지(정리할게요/앞서 말했듯/이 글에서는/본격적으로 들어가기 전에)
- **K-3** [S2] 한자어 2음절 대구 · fork 신규
  시그니처: 2음절 한자어 둘을 "과/와"로 묶어 개념을 압축하는 습관. 보고서 문체의…

## L. 로컬 확장 — 포괄어·구체성 (fork, 장르 불문, 2026-08-25)

- **L-1** [S2] 포괄어 남용 (Vague/Generic Noun) · fork 신규 — 상태·대상·축·자리·지점·층처럼 여러 의미를 두루 덮는 명사를 써서…
  시그니처: 포괄 명사(자리, 지점, 층, 상태, 대상, 축, 기제, 모양, 측면, 차…

## M. 로컬 확장 — 명료성 복원 (과압축 교정, fork, 장르 불문, 2026-08-31)

- **M-1** [S2] 문장 성분 생략 — 정보 결손 압축 · fork 신규 — 주어, 목적어, 부사어 중 의미를 지탱하는 성분이 빠져서 읽는 쪽이…
  시그니처: 주어 또는 목적어 부재로 지시 대상이 문맥에도 없는 서술 문장
- **M-2** [S2] 비완결 종결 — 명사구, 부사구, 연결어미 끝맺음 · fork 신규 — 산문 문장이 서술어와 종결어미 없이 끝난다. 명사형 종결("~함",…
  시그니처: 산문 문장이 명사형, 부사구, 연결어미로 종결(헤딩과 개조식 항목 제외)
- **M-3** [S2] 조사, 어미 탈락 — 전보문체 · fork 신규 — 문장 성분은 남아 있는데 그것들을 잇는 조사와 어미가 빠져 관계가…
  시그니처: 격조사 탈락으로 성분 관계가 불분명한 서술 문장, 시제와 태 표지 부재
- **M-4** [S2] 관형격 '의' 연쇄 — 의미 관계 은폐 · fork 신규 — 서술 관계로 풀어야 할 자리를 "~의"로 접어서 두 명사 사이의 관…
  시그니처: 한 문장에 관형격 "~의" 2회 이상 또는 명사+의+명사+의 연쇄
- **M-5** [S1] 비유적 어휘의 일반어 대체 · fork 신규 — 일반적인 명사나 동사를 써야 할 자리에 비유 어휘를 꽂아 의미가 변…
  시그니처: 일반 명사나 동사 자리의 비유 어휘, 관용 정착 표현은 제외 · 예: "분석의 흐름
- **M-6** [S2] 저빈도 현학 어휘 · fork 신규 — 사전에 있고 뜻도 명확하지만 실제 사용 빈도가 낮아 통용되지 않는…
  시그니처: 통용 빈도가 낮은 어휘가 표준 용어 자리가 아닌 곳에 출현
- **M-7** [S2] 문서 내 종결 격식 혼재 (산문, 장르 불문) · fork 신규 (2026-08-31 재eval) — 한 문서의 산문 문장이 합쇼체(~습니다), 한다체(~한다), 해요체…
  시그니처: 산문 문장의 종결 격식(합쇼/한다/해요)이 한 문서에 2종 이상 혼재
