...
M. 로컬 확장 — 명료성 복원 (과압축 교정, fork, 장르 불문) — M-1~M-6 + 충돌 조정표
...
- **복원을 포기해도 문장을 통째로 면제하지 않는다** (2026-08-31 3자 eval 실측). 픽스처의 "그러면 경고가 붙습니다" 한 문장에서 claude, codex, agy 셋 다 성분 복원을 정확히 포기했다 — 무슨 경고인지 원문에 근거가 없으니 옳은 판단이다. 그런데 **셋 중 둘이 그 문장의 격식까지 손대지 않아** 한다체로 통일된 글에 합쇼체 한 문장이 남았다. M-1의 보류가 E-7(청자 경어법 일관성)의 면제로 번진 것이다.
  - 규칙: M-1이 성분 복원을 포기한 문장에도 **E-7, E-2, A~L의 다른 처방은 그대로 적용한다.** 보류 대상은 그 문장의 **빠진 성분 하나**이지 문장 전체가 아니다.
