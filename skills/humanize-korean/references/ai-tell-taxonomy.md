...
> **로컬 fork 표기 (2026-08-20):** 본 파일은 `dennis7676/im-not-ai` fork이며 본진 A~J는 upstream 원문 그대로다. 로컬 확장은 **K절 하나뿐**이고 DP 개인글에만 적용된다 — 본진을 덮어쓰지 않는다는 것이 병합 규칙이다. upstream을 당길 때 충돌은 K절과 목차 한 줄에서만 난다.
